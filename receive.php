...
$conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
    ...
    else
    {
      ...
      $run_query = mysqli_query($conn, $query);
        ...
        $sql = "UPDATE accounts SET callee_name=NULL, callee_link=NULL, upcomming_call=NULL WHERE username='$username1'";
...
<button id="start" class="btn btn-light btn-lg" type="button"><b>Connect With <?php echo $caller_name ?></b></button>
