...
<?php
      ...
      while ($row = mysqli_fetch_assoc($results))
      {
		...
		$c_department_name=$row["department_name"];
		$c_department_no=$row["department_no"];
		$c_section=$row["section"];
...
?>
				<tr>
					...
					<td><?php echo $c_department_name; ?></td>
					<td><?php echo $c_department_no; ?></td>
					<td><?php echo $c_section; ?></td>
					<td><?php echo $c_designation; ?></td>

					<td>

					<button onclick="location.href='admin1.php?var=<?php echo $c_username;?>';">More</button>
