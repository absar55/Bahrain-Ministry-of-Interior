      ...
      <div class="container-fluid">
         <div class="layout_main">
            ...
            <!-- banner section end -->
              ...
              <div class="order_section" style="padding-top:40px;">
                        <div class="order_taital_main2" >
                        
                              <div class="order_bt2"><a href="Assistant_Undersecretary.php">Assistant Undersecretary of Human Resources</a></div> 
                        </div>
                     </div>


                     <div class="row" style="padding-top:70px; padding-bottom:130px;">
                              ...
                              <div class="column" style="width:33.33%">
                                 ...
                                 <div class="order_section">
                                    <div class="order_taital_main3" >
            
                                          <div class="order_bt3"><a href="Officers_Affairs.php">Officers Affairs</a></div> 
                                    </div>
                                 </div>     
                              </div>
                              <div class="column" style="width:33.33%">
                                 <div class="order_section">
                                    <div class="order_taital_main3" >
                                          ...
                                          <div class="order_bt3"><a href="Personal_Affairs.php">Personal Affairs</a></div> 
                                    </div>
                                 </div>     
                              ...
                              <div class="column" style="width:33.33%">
                                 <div class="order_section">
                                    <div class="order_taital_main3" >
                                          ...
                                          <div class="order_bt3"><a href="Civilian_Affairs.php">Civilian Affairs</a></div> 
                                    </div>
                                 </div>     
