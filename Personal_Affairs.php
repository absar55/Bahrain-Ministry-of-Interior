         ...
         <div class="layout_main">
            ...
            <!-- banner section end -->
                     ...
                     <div class="order_section">
                        <div class="order_taital_main4">
                           <div class="order_bt4"><a href="#">Personals Affairs</a></div>
              ...
              <!-- order section end -->
                     ...
                     <div class="order_section">
                        <div class="order_taital_main">
                           <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,1,S1">Section 1</a></div>
                            <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,2,S1">Section 1</a></div>
               ...
               <!-- order section start -->
                     <div class="order_section">
                        <div class="order_taital_main">
                           <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,1,S2">Section 2</a></div>
                            <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,2,S2">Section 2</a></div>
              ...
              <!-- order section end -->
               <!-- order section start -->
                     <div class="order_section">
                        <div class="order_taital_main">
                           <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,1,S3">Section 3</a></div>
                            <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,2,S3">Section 3</a></div>
              ...
              <!-- order section end -->
               <!-- order section start -->
                     <div class="order_section">
                        <div class="order_taital_main">
                           <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,1,O1">Office 1</a></div>
                            <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,2,O1">Office 1</a></div>
              ...
              <!-- order section end -->
               <!-- order section start -->
                     <div class="order_section">
                        <div class="order_taital_main">
                           <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,1,O2">Office 2</a></div>
                            <div class="order_bt"><a href="structure.php?variable=Personal_Affairs,2,O2">Office 2</a></div>
